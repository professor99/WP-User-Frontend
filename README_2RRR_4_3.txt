README WP User Frontend Version: 1.1.0-fork-2RRR-4.3 alpha
========================================================
...
It also fixes a few bugs with attachment and images uploads (particulary with WordPress 3.5.1) and now
links these properly with there parent post rather than being 'unattached' in the Media Library. 
...
http://2rrr.org.au/downloads/wp-user-frontend/2RRR_4_3/wp-user-frontend_1_1_2RRR_4_3_alpha.zip
